...
IMPORTANT: Tests use MockNormalizerBackend for deterministic execution.
LLM auto-detection is disabled during tests via module-level patch.
"""
...
pytest_plugins = ["cfa.testing.fixtures"]


def pytest_configure(config):
    """Disable LLM auto-detection during test runs."""
    import cfa.testing.evaluate as _eval_mod
    _eval_mod._detect_llm_backend = lambda: None
