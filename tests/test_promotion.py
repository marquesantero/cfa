...
class TestKernelIntegration:
    def test_kernel_records_execution_and_evaluates(self):
        ...
        # Should have promotion event in validate phase
        promo_events = [e for e in result.audit_events if e.get("stage") == "validate"]
    ...
    def test_kernel_multiple_runs_may_promote(self):
        ...
        for _ in range(5):
            kernel.process("Join NFe with Clientes and persist to Silver")
